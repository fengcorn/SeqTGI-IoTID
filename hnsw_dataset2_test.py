...
def main():
    ...
    # 数据集评估
    print("\nEvaluating dataset...")
    raw_data_path = '/home/fengcorn/code/SeqTGI-IoTID/Ex2_dscgru_predict_result_raw.npy'
    y_raw_path = '/home/fengcorn/code/SeqTGI-IoTID/Ex2_dscgru_y_raw.npy'
    y_train_path = '/home/fengcorn/code/SeqTGI-IoTID/Ex2_dscgru_y_train.npy'
